          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @if (get_user_permission("Category","add"))
                      <a href="{{route('category.create')}}" class="btn btn-sm btn-info " style="float: right">Add Category</a>
                    @endif
                </div>
                <!-- /.card-header -->
                <div class="card-body">
...
<script>
  $(document).ready(function() {
    $('#CategoryTable').DataTable({
      ...
      'columnDefs': [ {
        'targets': [2,4,5], // column index (start from 0)
