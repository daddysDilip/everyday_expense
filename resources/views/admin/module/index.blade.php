          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    {{get_user_permission("Module","add")}}
                    @if (get_user_permission("Module","add"))
                      <a href="{{route('module.create')}}" class="btn btn-sm btn-info " style="float: right">Add Module</a>
                    @endif
                </div>
                <!-- /.card-header -->
                <div class="card-body">
...
<script>
  ...
  $('.changeCategoryStatus').click(function() {
    ...
    $.ajax({
      type: "GET",
      url: "{{url('change-module-status')}}?id=" + id + "&status=" + status,
